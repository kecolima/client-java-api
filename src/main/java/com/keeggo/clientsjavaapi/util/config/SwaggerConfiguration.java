...
public class SwaggerConfiguration {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.keeggo.clientsjavaapi.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Clients Java API")
				.description("Clients Java API - Endpoint's documentation").version(releaseVersion.concat("_").concat(apiVersion))
				.build();
	}
