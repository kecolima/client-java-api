...
import com.keeggo.clientsjavaapi.util.interceptor.RateLimitInterceptor;
...
public class RateLimitingConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(interceptor).addPathPatterns("/api-clients/v1/clients/**",
        		"/api-clients/v1/statistics/**");
    }
