...
import com.keeggo.clientsjavaapi.util.converters.BigDecimalConverter;
import com.keeggo.clientsjavaapi.util.converters.LocalDateTimeConverter;
 ...
 */
@Configuration
public class ClientsApiConfiguration {
