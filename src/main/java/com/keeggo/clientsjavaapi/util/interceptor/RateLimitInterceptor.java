package com.keeggo.clientsjavaapi.util.interceptor;
...
public class RateLimitInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
    	...
    	String apiKey = request.getHeader(ClientsApiUtil.HEADER_API_KEY);
    	
        if (apiKey == null || apiKey.isEmpty()) {
            response.sendError(HttpStatus.BAD_REQUEST.value(), "Missing Header: " + ClientsApiUtil.HEADER_API_KEY);

            log.error("Missing Header: " + ClientsApiUtil.HEADER_API_KEY);
            return false;
        }
        ...
        if (probe.isConsumed()) {
            ...
            response.addHeader(ClientsApiUtil.HEADER_LIMIT_REMAINING, String.valueOf(probe.getRemainingTokens()));
            return true;
            ...
            response.addHeader(ClientsApiUtil.HEADER_RETRY_AFTER, String.valueOf(waitForRefill));
