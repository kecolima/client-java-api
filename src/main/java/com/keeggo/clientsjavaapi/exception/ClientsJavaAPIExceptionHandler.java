 ...
 */
@ControllerAdvice
public class ClientsJavaAPIExceptionHandler<T> {
	
	/**
	 * Method that handles with a ClientInvalidUpdateException and returns an error with 
	 * status code = 403.
	 * 
	 * @author Mariana Azevedo
	 * @since 01/04/2020
	...
	/**
	 * Method that handles with a ClientNotFoundException and returns an error with 
	 * status code = 404.
	 * 
	 * @author Mariana Azevedo
	 * @since 01/04/2020
	...
	/**
	 * Method that handles with a ClientsJavaAPIException and returns an Internal Server Error 
