package com.keeggo.clientsjavaapi.controller.v1.account;
...
import com.keeggo.clientsjavaapi.exception.AccountNotFoundException;
import com.keeggo.clientsjavaapi.exception.ClientNotFoundException;
import com.keeggo.clientsjavaapi.model.account.Account;
import com.keeggo.clientsjavaapi.service.account.AccountService;
...
@Log4j2
@RestController
@RequestMapping("/api-clients/v1/accounts")
public class AccountController {
	...
	/**
	 * Method that creates a account in the Clients Java API.
	 * 
	 * @author Mariana Azevedo
	 * @since 31/10/2020
	 * 
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<AccountDTO>> create(@RequestHeader(value=ClientsApiUtil.HEADER_CLIENTS_API_VERSION, 
	...
	public ResponseEntity<Response<List<AccountDTO>>> findByAccountNumber(@RequestHeader(value=ClientsApiUtil.HEADER_CLIENTS_API_VERSION, defaultValue="${api.version}") 
		String apiVersion, @RequestHeader(value=ClientsApiUtil.HEADER_API_KEY, defaultValue="${api.key}") String apiKey, 
	...
	public ResponseEntity<Response<AccountDTO>> findById(@RequestHeader(value=ClientsApiUtil.HEADER_CLIENTS_API_VERSION, 
		defaultValue="${api.version}") String apiVersion, @RequestHeader(value=ClientsApiUtil.HEADER_API_KEY, defaultValue="${api.key}") 
