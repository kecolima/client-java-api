package com.keeggo.clientsjavaapi.controller.v1.user;
...
import com.keeggo.clientsjavaapi.controller.v1.client.ClientController;
import com.keeggo.clientsjavaapi.dto.model.user.UserAccountDTO;
 ...
 */
@RestController
@RequestMapping("/api-clients/v1/users-accounts")
public class UserAccountController {
	...
	/**
	 * Method that creates an association with the user and a account in the Clients API.
	 * 
	 * @author Mariana Azevedo
	 * @since 13/10/2020
	 * 
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<UserAccountDTO>> create(@RequestHeader(value=ClientsApiUtil.HEADER_CLIENTS_API_VERSION, 
	...
	private void createAccountRelLink(UserAccount userAccount, UserAccountDTO userAccountDTO) {
		Link relTransactionLink = WebMvcLinkBuilder.linkTo(ClientController.class)
