package com.keeggo.clientsjavaapi.controller.v1.security;
...
import com.keeggo.clientsjavaapi.dto.model.security.TokenDTO;
import com.keeggo.clientsjavaapi.dto.response.Response;
import com.keeggo.clientsjavaapi.util.ClientsApiUtil;
import com.keeggo.clientsjavaapi.util.security.JwtTokenUtil;
 ...
 */
@RestController
@RequestMapping("/api-clients/v1/auth")
public class AuthenticationController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<TokenDTO>> generateTokenJwt(@RequestHeader(value=ClientsApiUtil.HEADER_CLIENTS_API_VERSION, defaultValue = "${api.version}") 
