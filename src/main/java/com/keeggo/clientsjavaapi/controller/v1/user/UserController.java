 ...
 */
@RestController
@RequestMapping("/api-clients/v1/users")
public class UserController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<UserDTO>> create(@RequestHeader(value=ClientsApiUtil.HEADER_CLIENTS_API_VERSION, defaultValue="${api.version}") 
